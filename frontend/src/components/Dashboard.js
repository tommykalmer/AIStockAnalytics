...
const styles = {
  ...
  main: { textAlign: "center", marginTop: "60px" },
  featureList: { listStyleType: "none", padding: 0, fontSize: "18px", marginTop: "20px", color: "#444" },
  footer: { marginTop: "auto", textAlign: "center", fontSize: "14px", color: "#888", padding: "20px" },
};
